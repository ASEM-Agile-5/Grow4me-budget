# Generated by Django 6.0.4 on 2026-04-11 23:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updates', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255), blank=True, default=list)),
                ('location', models.CharField(max_length=255)),
                ('current_balance', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
                ('users', models.ManyToManyField(related_name='projects', through='project.Membership', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='backlog', to='project.projects')),
            ],
        ),
    ]
